...
let TeachersController = class TeachersController {
    ...
    addAbsence(id, createAbsenceDto) {
...
__decorate([
    (0, common_1.Post)(':id/absences'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, create_absence_dto_1.CreateAbsenceDto]),
    __metadata("design:returntype", void 0)
], TeachersController.prototype, "addAbsence", null);
