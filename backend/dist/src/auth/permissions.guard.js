...
let PermissionsGuard = class PermissionsGuard {
    ...
    canActivate(context) {
        ...
        if (!user || !user.permisos) {
            throw new common_1.ForbiddenException('Permisos insuficientes o no definidos');
        }
        ...
        if (!hasPermission) {
            throw new common_1.ForbiddenException(`Requiere los permisos: ${requiredPermissions.join(', ')}`);
        }
        return true;
    }
};
